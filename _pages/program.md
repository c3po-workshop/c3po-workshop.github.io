...
**Chunhua (Leo) Liao (LLNL)**](/presentations/building_source-to-source_tools_for_hpc.pdf) \\
...
[**Van-Man Nguyen (CEA) - Automatic Code Motion to Extend MPI Nonblocking Overlap Window**](/presentations/automatic_code_motion_to_extend_mpi_nonblocking_overlap_window.pdf) \\
...
[**Adrian Munera Sanchez (BSC) - Static analysis to enhance programmability and performance in OmpSs-2**](/presentations/static_analysis_to_enhance_programmability_and_performance_in_ompss.pdf) \\
